...
public class Level1Shapes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level1_shapes);
        addListenerOnButton();
    }
    ...
    public void addListenerOnButton() {
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                truth = findViewById(R.id.radioTriangle);

                if (radioShapeButton == truth) {
                    Toast.makeText(Level1Shapes.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Level2Shapes.class);
                    startActivity(l);

                } else {
                    Toast.makeText(Level1Shapes.this,
