...
public class Level5Shapes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level5_shapes);
        addListenerOnButton();
    }
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (radioShapeButton == truth) {
                    Toast.makeText(Level5Shapes.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Level6Shapes.class);
                    startActivity(l);


                } else {
                    Toast.makeText(Level5Shapes.this,
