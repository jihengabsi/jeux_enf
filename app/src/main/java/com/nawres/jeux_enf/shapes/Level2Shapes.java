...
public class Level2Shapes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level2_shapes);
        addListenerOnButton();
    }
    ...
    public void addListenerOnButton() {
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                truth = findViewById(R.id.radioCircle);

                if (radioShapeButton == truth) {
                    Toast.makeText(Level2Shapes.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Level3Shapes.class);
                    startActivity(l);

                } else {
                    Toast.makeText(Level2Shapes.this,
