...
public class animals2 extends AppCompatActivity {
    ...
    public void addListenerOnButton() {
        ...
        btnDisplay1 = findViewById(R.id.choose);
        ...
        btnDisplay1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (radioShapeButton == truth) {
                    ...
                    Toast.makeText(animals2.this, "True", Toast.LENGTH_LONG).show();
                    Intent i = new Intent(getApplicationContext(), animals3.class);
                    startActivity(i);

                } else {
                    Toast.makeText(animals2.this,
