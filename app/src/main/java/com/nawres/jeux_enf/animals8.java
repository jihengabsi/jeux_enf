...
public class animals8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animals8);
    ...
    public void addListenerOnButton() {
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                truth = findViewById(R.id.radioButton3);

                if (radioShapeButton == truth) {

                    Toast.makeText(animals8.this, "True", Toast.LENGTH_LONG).show();
                    Intent i = new Intent(getApplicationContext(), animals9.class);
                    startActivity(i);

                } else {
                    Toast.makeText(animals8.this,
