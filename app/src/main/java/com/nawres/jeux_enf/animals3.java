...
public class animals3 extends AppCompatActivity {
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (radioShapeButton == truth) {
                    ...
                    Toast.makeText(animals3.this, "True", Toast.LENGTH_LONG).show();
                    Intent i = new Intent(getApplicationContext(), animal4.class);
                    startActivity(i);

                } else {
                    Toast.makeText(animals3.this,
    ...
    public void cheat(View view) {
        Toast.makeText(animals3.this,
                "This is very easy sorry i can't help you on that !", Toast.LENGTH_LONG).show();
    }
