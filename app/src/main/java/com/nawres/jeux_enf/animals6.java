...
public class animals6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animals6);
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (radioShapeButton == truth) {
                    ...
                    Toast.makeText(animals6.this, "True", Toast.LENGTH_LONG).show();
                    Intent i = new Intent(getApplicationContext(), animals7.class);
                    startActivity(i);

                } else {
                    Toast.makeText(animals6.this,
    ...
    public void cheat(View view) {
        Toast.makeText(animals6.this,
                "Dolphin", Toast.LENGTH_LONG).show();
    }
}
