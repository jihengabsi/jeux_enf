...
public class animals7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animals7);
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (radioShapeButton == truth) {
                    ...
                    Toast.makeText(animals7.this, "True", Toast.LENGTH_LONG).show();
                    Intent i = new Intent(getApplicationContext(), animals8.class);
                    startActivity(i);

                } else {
                    Toast.makeText(animals7.this,
