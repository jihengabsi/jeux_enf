...
public class Level5Colors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level5_colors);
        addListenerOnButton();
    }
    ...
    public void addListenerOnButton() {
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (choice.getText().toString().equals("yellow")) {
                    Toast.makeText(Level5Colors.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Level6Colors.class);
                    startActivity(l);

                } else {
                    Toast.makeText(Level5Colors.this,
