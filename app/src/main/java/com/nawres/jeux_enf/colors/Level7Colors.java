...
public class Level7Colors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level7_colors);
        addListenerOnButton();
    }
    ...
    public void addListenerOnButton() {
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (choice.getText().toString().equals("violet")) {
                    Toast.makeText(Level7Colors.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Level8Colors.class);
                    startActivity(l);

                } else {
                    Toast.makeText(Level7Colors.this,
