...
public class Level4Colors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level4_colors);
        addListenerOnButton();
    }
    ...
    public void addListenerOnButton() {
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (choice.getText().toString().equals("pink")) {
                    Toast.makeText(Level4Colors.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Level5Colors.class);
                    startActivity(l);

                } else {
                    Toast.makeText(Level4Colors.this,
